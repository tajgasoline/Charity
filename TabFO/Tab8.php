                                             ...
                                             <div class="col-md-6">
                                               ...
                                               <div class="form-group row">
                                                ...
                                                <div class="col-sm-8 ">
                                                 ...
                                                 <input type="text" class="form-control numbersOnly" id="AmountApplied2" placeholder="Enter Amount">
                                                </div> 
...
<div class="row login-logo">
           ...
           <div class="col-md-3 cust-card-left-button">
             ...
             <div class="col-md-3 cust-card-right-button">
                    <button class="btn btn-primary  btn-block waves-effect waves-light" onclick="onloadss();" id="page-two-button" type="button">Submit</button>
                </div>
                <div class="col-md-3"></div>
            </div>
</div><!--end card-->
