...
<body>
    ...
    <div class="page-wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-2 col-sm-2 col-md-12">
                                            ...
                                            <div class="tab-content">
                                                <?php
                                                include('TabIA/Tab0.php');
                                                include('TabIA/Tab1.php');
                                                include('TabIA/Tab2.php');
                                                include('TabIA/Tab3.php');
                                                include('TabIA/Tab4.php');
                                                include('TabIA/Tab5.php');
                                                include('TabIA/Tab6.php');
                                                include('TabIA/Tab7.php');
                                                include('TabIA/Tab8.php');
                                                include('TabIA/Tab9.php');
        ...
        <script src="functions/IndividualAuthority.js"></script>
        <!-- App js -->
