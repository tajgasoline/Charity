        ...
        <select class="select2 form-control  custom-select " style="width: 100%; height:36px;" tabindex="-1" aria-hidden="true" id="employment">
            ...
            <option value="UnEmployeed">UnEmployeed</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 "> 
                        <select class="select2 form-control  custom-select " style="width: 100%; height:36px;" tabindex="-1" aria-hidden="true" id="city" >
        ...
        <span class="help-block custom-block-hide" id="62v"><small ></small></span>
            ...
            <div class="row login-logo">
                ...
                <div class="col-md-3 cust-card-left-button">
                    <button class="btn btn-primary  btn-block waves-effect waves-light"  value="page0" onclick="switching(this.value);" type="button" >Preview</button>
                </div>
