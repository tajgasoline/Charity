...
function function10(){
    ...
    $("#201v").css("display", "none");
    $("#202v").css("display", "none");
    $("#203v").css("display", "none");
    $("#204v").css("display", "none");
    $("#205v").css("display", "none"); 

    if(employment == '' || employment == null){

         $("#201v").css("display", "block");
         $("#201v").html('Please Fill this.');
         $("#employment").focus();
      
                          return false;
    } else  if(Muslim == '' || Muslim == null){
         $("#202v").css("display", "block");
         $("#202v").html('Please Fill this.');
         $("#Muslim").focus();
                          return false;
    } else  if(Syed == '' || Syed == null){
         $("#203v").css("display", "block");
         $("#203v").html('Please Fill this.');
         $("#Syed").focus();
                          return false;
    } else  if(casetype == '' || casetype == null){
         $("#204v").css("display", "block");
         $("#204v").html('Please Fill this.');
         $("#casetype").focus();
                          return false;

    } else  if(casedesc == '' || casedesc == null){
         $("#205v").css("display", "block");
         $("#205v").html('Please Fill this.');
         $("#casedesc").focus();
                 return false;
    }
    else {
...
function function6() {
    ...
    var options='<option value="null" selected disabled>Select Type</option>'+ 
                ...
                success: function (data) {
                    ...
                    if (result == "Inserted") {
                        Swal.fire({
                            ...
                            window.location.href = "CharityFinance.php";
                        });
